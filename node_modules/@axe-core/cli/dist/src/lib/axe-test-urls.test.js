...
const axe_test_urls_1 = require("./axe-test-urls");
describe('testPages', function () {
    ...
    it('waits until the document is ready to have a className added', () => __awaiter(this, void 0, void 0, function* () {
        const asyncScripts = [];
        let waitCalls = 0;
        ...
        mockDriver.wait = (script) => __awaiter(this, void 0, void 0, function* () {
            waitCalls++;
            return script;
        });
        yield (0, axe_test_urls_1.default)(['http://foo'], config);
        const script = asyncScripts.find(scr => {
            return scr.match(/script\.innerHTML\s*=[\s\S]*['"]document\.documentElement\.classList\.add\(['"]deque-axe-is-ready/);
        });
        chai_1.assert.isDefined(script);
